...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  cashier: ['planner.view', 'shift_changes.view_own', 'shift_changes.create', 'shift_changes.respond'],
  kitchen: ['planner.view', 'shift_changes.view_own', 'shift_changes.create', 'shift_changes.respond'],
