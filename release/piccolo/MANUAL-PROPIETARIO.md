# Manual del propietario — Piccolo TPV 0.9.0-rc.2
...
Es una versión candidata para pruebas. Las pruebas físicas deben completarse antes del piloto. **No usar para facturación fiscal real.**
