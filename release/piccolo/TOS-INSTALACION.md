# Piccolo TPV 0.9.0-rc.1 — Instalación en TerraMaster TOS (F4-424)
...
Descarga el paquete `Piccolo-TPV-0.9.0-rc.1-TOS-linux-amd64-*.tar.gz` desde la GitHub Release o el artefacto de CI. Verifica el checksum SHA-256 antes de instalar.
...
```bash
cd /Volume1/piccolo
tar -xzf Piccolo-TPV-0.9.0-rc.1-TOS-linux-amd64-*.tar.gz
...
- Release candidate `0.9.0-rc.1` — no declarada producción.
