...
Object.assign(process.env, {
  NODE_ENV: "production",
  PICCOLO_VERSION: process.env.PICCOLO_VERSION ?? "0.9.0-rc.2",
  PICCOLO_COMMIT: process.env.PICCOLO_COMMIT
    ?? (fs.existsSync(path.join(appRoot, "COMMIT.txt"))
      ? fs.readFileSync(path.join(appRoot, "COMMIT.txt"), "utf8").trim()
      : "unknown"),
