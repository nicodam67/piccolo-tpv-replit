...
Write-PiccoloLog $DataRoot "Inicio del configurador guiado Piccolo TPV 0.9.0-rc.1."
...
Write-Host "Piccolo TPV 0.9.0-rc.1 instalado. Solo para pruebas." -ForegroundColor Green
